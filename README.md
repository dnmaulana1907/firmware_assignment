...
| :--- | :--- | :--- | :--- | :--- |
| **STM32F4 Discovery** | - | - | MCU (STM32F407VGT6) | [Link]([Link])|
| **Quectel LG290P** | UART (DMA) | `PB6` (TX), `PB7` (RX) | GNSS Module (9600/115200 bps) | [Link](https://docs.sparkfun.com/SparkFun_RTK_Postcard/assets/component_documentation/Quectel_LG290P_GNSS_Protocol_Specification_v1-0.pdf$0)|
| **PPS Signal** | GPIO EXTI | `PA0` | Pulse Per Second for Wakeup (Optional) | - |
| **BME280** | I2C | `PB8` (SCL), `PB9` (SDA) | Temp, Pressure, Humidity Sensor |[Link](https://www.bosch-sensortec.com/media/boschsensortec/downloads/datasheets/bst-bme280-ds002.pdf$0) |
